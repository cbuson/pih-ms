#!/usr/bin/env python3
"""Empacota a entrega independente PIH MS V2.5."""
from pathlib import Path
from zipfile import ZIP_DEFLATED, ZipFile


ROOT = Path(__file__).resolve().parents[1]
OUTPUT = ROOT.parent.parent / "outputs/6b2168c6942b/pih-ms-v2.5-estabilidade-sensibilidade.zip"
TOP_LEVEL = "pih-ms-v2.5-estabilidade-sensibilidade"
